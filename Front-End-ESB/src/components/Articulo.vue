                    ...
                    <v-dialog v-model="dialog" max-width="500px">
                        ...
                        <v-card>
                            ...
                            <v-container grid-list-md>
                                <v-layout wrap>
                                <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="codigo" label="id">
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <v-select v-model="idcategoria"
                                    :items="categorias" label="direccion">
                                    </v-select>
                                </v-flex>
                                <v-flex xs12 sm12 md12>
                                    <v-text-field v-model="nombre" label="bomberoCargo"></v-text-field>
                                </v-flex>
                                <v-flex xs12 sm12 md12>
                                    <v-text-field v-model="descripcion" label="fechaCreacion"></v-text-field>
                                </v-flex>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo Registro de incendios' : 'Actualizar Registro de incendios'
            }
        },
        ...
        methods:{
            listar(){
                ...
                axios.get('api/RegistroIncendios/GetListAllasync').then(function(response){
                    ...
                    me.articulos=response.data.data;
